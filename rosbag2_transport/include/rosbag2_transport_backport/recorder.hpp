...
#ifndef ROSBAG2_TRANSPORT_BACKPORT__RECORDER_HPP_
#define ROSBAG2_TRANSPORT_BACKPORT__RECORDER_HPP_
...
public:
  ...
  const std::unordered_map<std::string, std::shared_ptr<rosbag2_transport::GenericSubscription>> &
  subscriptions() const
  {
...
private:
  ...
  std::shared_ptr<rosbag2_transport::GenericSubscription> create_subscription(
  ...
  std::unordered_map<std::string,
    std::shared_ptr<rosbag2_transport::GenericSubscription>> subscriptions_;
...
#endif  // ROSBAG2_TRANSPORT_BACKPORT__RECORDER_HPP_
